...
ALTER TABLE "ITEM_TRANSACTION" ADD CONSTRAINT "FK_ITEM_TRANSACTION_ITEM_BALANCE_1" FOREIGN KEY ("ITEM_CODE") REFERENCES "ITEM_BALANCE" ("ITEM_CODE");
ALTER TABLE "ITEM_TRANSACTION" ADD CONSTRAINT "FK_ITEM_TRANSACTION_WHAREHOUSE_1" FOREIGN KEY ("WH_CODE") REFERENCES "WHAREHOUSE" ("WH_CODE");
ALTER TABLE "TR_CODE" ADD CONSTRAINT "FK_TR_CODE_ITEM_TRANSACTION_1" FOREIGN KEY ("TR_TYPE") REFERENCES "ITEM_TRANSACTION" ("TR_TYPE");
